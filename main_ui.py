...
"}")
        ...
        self.tabWidget_4.setGeometry(QRect(0, 0, 411, 491))
        self.tab_9 = QWidget()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_9), QCoreApplication.translate("MainWindow", u"Active", None))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_10), QCoreApplication.translate("MainWindow", u"Passive", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QCoreApplication.translate("MainWindow", u"Filter", None))
    # retranslateUi
